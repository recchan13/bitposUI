                ...
                <div class="big-card">
                    <div class="centered-wrapper">
                        ...
                        <form action="email.php" id="email">
                            <input style="font-size: 25px" type="text" id="email" name="email" placeholder="Email">
                            <input style="font-size: 25px" type="password" id="password" name="password" placeholder="Password">
