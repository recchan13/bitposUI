            ...
            <div class="row">
                <div class="big-card">
                    <div class="centered-wrapper">
                        <h4>Form Sub-Kategori</h4>
                        <form action="subkategori.php" id="subkategori_tambah">
                            ...
                            <button type="submit" class="btn btn-submit" form="subkategori_tambah" value="Submit">Submit</button>
